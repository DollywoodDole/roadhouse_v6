...
const BRANCHES: Branch[] = [
  ...
  },
  {
    num: '03',
    name: 'Studio',
    domain: 'studio.roadhouse.capital',
    href: 'https://studio.roadhouse.capital',
    description: 'Creative and build arm. Client work, house IP, and production — all under one roof.',
    status: 'live',
    stat: null,
    entity: 'RoadHouse',
    preview: '/studio-preview.jpg',
  },
  {
    num: '04',
    name: 'Coconut Cowboy',
      ...
      {vehicles.map((v) => (
        ...
        >
          ...
          <div className="relative overflow-hidden" style={{ aspectRatio: '16/9' }}>
            ...
            {/* Watermark */}
            <div className="absolute right-0 z-10" style={{ top: '2%' }}>
